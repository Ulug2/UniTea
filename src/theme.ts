export const lightTheme = {
    ...
    text: '#183153',            // Midnight blue for text
    secondaryText: '#6B7280',   // Gray for secondary text
...
export const darkThemeMidnight = {
    background: '#0D1B2A',      // Dark midnight background
    card: '#183153',            // Midnight blue cards
    text: '#F8F9FB',            // Off-white text
    secondaryText: '#9CA3AF',   // Light gray for secondary text
    border: '#2A4A6F',          // Lighter midnight blue border
    primary: '#2FC9C1',         // Turquoise primary
    primaryDark: '#28B3AC',     // Darker turquoise for hover states
