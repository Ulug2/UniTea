-- Adjust hot feed time decay to be less aggressive.
--
-- Follow-up migration because the previous dynamic hot_score migration
-- has already been applied.
--
-- Change:
--   POWER((Age_in_Hours + 2), 1.6) -> POWER((Age_in_Hours + 2), 1.3)
